def get_suggestion_url(service_name):
...
if __name__ == '__main__':
    print(f"Google Suggestion URL: {get_suggestion_url('google')}")
    print(f"YouTube Suggestion URL: {get_suggestion_url('youtube')}")
    
    youtube_url_template = get_suggestion_url('youtube')
    print(f"YouTube URL Template: {youtube_url_template}")